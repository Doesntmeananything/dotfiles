...
plugins=(z zsh-syntax-highlighting zsh-autosuggestions common-aliases git nvm zsh-completions fzf)
...
# Workaround to access ISP-blocked Elm resources in Russia
alias elm-proxy="https_proxy=elm.dmy.fr:9999"
